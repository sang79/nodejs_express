...
app.engine('hbs', handlebars({
  ...
  helpers: {
    sum: (a, b) => a + b,
    // hàm này là 1 dạng hàm helper dùng để custom file trong node, cái này dựa trên express hbs, nhưng vì nó dc xây dựng trên hbs.jjs nên khi tham khảo ta nên xem qua cả 2 thư viện và lưu ý việc chúng xây dựng dựa vào những nền tảng cơ bản của nhau!
    // ở đây đang giải quyết việc tính toán , xây dựng 1 hàm, tính giá trị index bên thằng store-courese của MeControllers
  }
}));
